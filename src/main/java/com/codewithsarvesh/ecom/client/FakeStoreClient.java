package com.codewithsarvesh.ecom.client;

import com.codewithsarvesh.ecom.dto.FakeStoreCartResponseDTO;
...
public class FakeStoreClient {
    ...
    public List<FakeStoreProductResponseDTO> getAllProducts(){
        ...
        System.out.print(List.of(productResponseList.getBody()));
